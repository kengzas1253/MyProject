...
public class CharterbankView extends AppCompatActivity {
    private GyroscopeObserver gyroscopeObserver3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_charterbank_view);

        gyroscopeObserver3 = new GyroscopeObserver();
        gyroscopeObserver3.setMaxRotateRadian(Math.PI/9);

        PanoramaImageView panoramaImageView = (PanoramaImageView)findViewById(R.id.panorama_charterbank);
